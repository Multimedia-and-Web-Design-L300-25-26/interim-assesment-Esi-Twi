...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen pb-[65px] bg-[#0a0b0d] text-white font-sans relative">
      {/* Coinbase Logo */}
      ...
      <div className="flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-[400px]">
          <p className="mb-3 text-gray-400">Demo app - do not use your real password</p>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-600 rounded-lg bg-transparent"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-3.5 bg-[#1a3a5c] hover:bg-[#1f4570] text-white font-semibold rounded-full transition-colors text-[15px] cursor-pointer mb-6" disabled={loading} onClick={handleLogin}
          >
